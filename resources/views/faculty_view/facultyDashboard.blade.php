        ...
        <div class="container-fluid">
            ...
            <div class="panel details">
                ...
                <div class="detailsText">
                    ...
                    <div class="dept"><?php echo $info->department ?></div>
                    <div class="college"><?php echo $info->college_name ?></div>
            ...
            <div class="panel content">
                ...
                @foreach($subjects as $sub)
                    <div class="card"> 
                        ...
                        <a href="{{ URL::to('facultySubject/subject/' . $sub->subject_id) }}">
                            <div class="cardheader" style="background-color: #c48ac4;">
                                {{$sub->subject_name}} / {{$sub->subject_code}}
                            </div>
                        </a>                       
                        <div class="cardcenter">
                            <div class="by">{{$sub->semester}} Semester</div>
                            <strong><div class="profname">{{$sub->dept}}</div></strong>
                        </div>
