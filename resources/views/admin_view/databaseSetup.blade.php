...
<body>
        ...
        <div class="container">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3 class="panel-title">Upload Faculty Database</h3>
                </div>
                <div class="panel-body">
                        ...
                        <div class="col-md-8 col-md-offset-2">
                            <div class="well">
                                <div class="text-center">
                                    <form id="myDropzone" style="margin-top: 15px;padding: 10px;" action="{{ URL::to('uploadFacultyDatabase') }}" class="form-horizontal dropzone dz-clickable" method="post" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        <div class="col-md-offset-10">
                            <button id="studentDatabaseBtn" type="button" class="btn btn-success">Next</button>
                        </div>
                    </div>
  ...
  init: function() {
    ...
    $(document).on("click","#studentDatabaseBtn",function(e){
        e.preventDefault();                   
        var url   = '{{url("/goToCourse/studentDatabase")}}';//"http://localhost/production/goToCourse/database";
        $.ajax({           
           url : url,
           type: 'GET'
        }).done(function(data){                     
