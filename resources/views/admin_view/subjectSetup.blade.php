...
<body>
    ...
    <div class="container-fluid" >
        <div class = "center-block" style = "width:500px; " >
           <span style="color:grey">Department</span> <span class = "glyphicon glyphicon-chevron-right"></span><span style="color:grey">Course</span><span class = "glyphicon glyphicon-chevron-right"></span> <strong>Subject</strong> <span class = "glyphicon glyphicon-chevron-right"></span><span style="color:grey"> Database</span> 
        </div>
        <div class="col-md-4">
                ...
                @foreach($info as $dept)    
                    <div class="panel panel-default">
                        <div class="panel-heading ">
                            ...
                            <a data-toggle="collapse" data-parent="#accordion" href="#collapse{{$dept->id}}">{{$dept->name}}</a><span class="glyphicon glyphicon-plus pull-right icon"></span>
                            </h4> 
                        </div>
